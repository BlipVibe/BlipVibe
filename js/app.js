...
var premiumSkins = [
    ...
    {id:'deep-wave',name:'Deep Wave',desc:'Dark muted neon. Deep purples and teal undertones with a glowing pulse.',price:1,preview:'linear-gradient(135deg,#1a0a3e,#0d2a3f,#2d1060,#0a1a2e)',border:'conic-gradient(from 0deg,#7b2ff7,#00d9f5,#4a1a8a,#00a67e,#7b2ff7)',icon:'fa-water',iconColor:'#7b5ff7',accent:'#7b5ff7',accentHover:'#5a2dc7',dark:true,cardBg:'#110a24',cardText:'#b8a0e0',cardMuted:'#6a50a0'}
];
