...
async function renderInlineComments(postId){
    ...
    el.querySelectorAll('.comment-react-btn').forEach(function(btn){
        btn.onclick=function(e){e.stopPropagation();showCommentReactionPicker(btn.dataset.cid,btn);};
    });
