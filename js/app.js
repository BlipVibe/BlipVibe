...
var premiumSkins = [
    ...
    {id:'deep-wave',name:'Deep Wave',desc:'Dark moody mints and teals with a glowing pulse. The shadowy side of Neon Wave.',price:1,preview:'linear-gradient(135deg,#003d2e,#1a5c4a,#0a2a3f,#004d40)',border:'conic-gradient(from 0deg,#00a67e,#007a5e,#004d40,#00c9a0,#00a67e)',icon:'fa-water',iconColor:'#00a67e',accent:'#00a67e',accentHover:'#007a5e',dark:true,cardBg:'#0a1f1a',cardText:'#80ddc0',cardMuted:'#408a70'}
];
